...
class KYCAdmin(admin.ModelAdmin):
    list_display = ('user_name', 'full_name', 'document_type', 'status', 'submitted_at', 'verified_at', 'verified_by_name')
    list_filter = ('status', 'document_type', 'submitted_at', 'verified_at')
    ...
    fieldsets = (
        ('User Information', {
            'fields': ('user', 'full_name', 'date_of_birth', 'address')
        }),
        ('Document Information', {
            'fields': ('document_type', 'document_number', 'document_front_image', 'document_back_image')
        }),
        ('Verification Status', {
    ...
    def approve_kyc(self, request, queryset):
        ...
        self.message_user(request, f'{updated} KYC verification(s) approved successfully.')
    ...
    def mark_under_review(self, request, queryset):
        ...
        self.message_user(request, f'{updated} KYC verification(s) marked as under review.')
    mark_under_review.short_description = "Mark selected KYC verifications as under review"
